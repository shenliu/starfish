starfish.toolkit.dialog = function() {
    ...
    return {
         ...
         *          }
         */
        caption: function(options, isParent) {
            ...
            html.push('<div class="sf_dialog_caption">');
            html.push('    <img align="middle" height="64" width="64" src="' + img + '" hspace="8" />');
            html.push('    <span>' + caution + '</span>');
            html.push('</div>');
            var sf_dialog_content = web.className("sf_dialog_content", isParent ? parent.document : document)[0];
         ...
         * @param options
         */
        content: function(tips, options, isParent) {
            var w = options.width, h = options.height;
            var html = [];
            html.push(tips);
            var sf_dialog_content = web.className("sf_dialog_content", isParent ? parent.document : document)[0];
        ...
        cancel: function(isParent) {
            var sf_dialog = web.className('sf_dialog', isParent ? parent.document : document)[0];
